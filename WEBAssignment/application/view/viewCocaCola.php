    ...
    <nav id="headerColor" class="navbar sticky-top navbar-expand-sm navbar_coca_cola">
      ...
      <div class="collapse navbar-collapse">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a id="navAbout" class="nav-link"  href="#" data-toggle="popover" data-trigger="hover" data-placement="bottom" title="About Web 3D Applications" data-content="More information about coca">About</a>
            </li>
            ...
            <div class="col-sm-4">
              <div class="card img-narrow">
                <a href="../application/assets/images/renderImages/fanta.jpg" data-fancybox data-caption="My 3D Fanta Can Render">
                  <img class="card-img-top img-fluid img-thumbnail" src="../application/assets/images/Fanta.jpg" >
                </a>
                <div class="card-body">
            ...
            <div class="col-sm-4">
              <div class="card img-narrow">
                <a href="../application/assets/images/renderImages/costa.jpg" data-fancybox data-caption="My 3D Costa Cup Render" >
                  <img class="card-img-top img-fluid img-thumbnail" src="../application/assets/images/Costa.jpg">
                </a>
                <div class="card-body">
            ...
            <div class="card">
              <div class="card-body">
                <div class="card-text">
                  ...
                  <div id="AboutSubtitle"></div>
                  <div id="AboutDescription" class="card-title drinksText"></div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="card">
              <div class="card-body">
                <div class="card-text">
                  <p><a href="../application/assets/x3d/x3d.zip" download>Download X3d Information</a></p>
                </div>
              </div>
            </div>
            </div>
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-body">
                ...
                <a href="https://www.coca-cola.co.uk/brands/coca-cola-original-taste" class="btn btn-primary btn-responsive">Visit Coca</a>                 
              </div>
            </div>
          </div>
